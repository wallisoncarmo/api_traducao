...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.carmowallison.base_api.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API de tradução",
				"API que controla as traduções de uma aplicação.", "Versão 1.0",
				"https://github.com/wallisoncarmo/api_traducao",
				new Contact("Wallison do Carmo Costa", "https://github.com/wallisoncarmo/api_traducao", "wallisoncarmo01@gmail.com"),
				null, 
